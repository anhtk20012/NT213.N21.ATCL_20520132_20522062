...
SET PASSWORD = PASSWORD('XCTFP@SSW0RDV3RYL0NGANDG00DLONGERTHANUSUALLY'); 
CREATE USER 'continental'@'localhost' IDENTIFIED BY 'XCTFP@SSW0RDV3RYL0NGANDG00DLONGERTHANUSUALLY';
...
INSERT INTO users VALUES (null, 'johnwick', md5('12345asdads123'), '', 1);
"""
